...
const payment= async ()=>{
  ...
  return (
    <div className="mt-16 flex flex-row">
      ...
      <div>
      <div className="right flex flex-col fixed  justify-between border w-full pr-6 bg-cyan-50   drop-shadow-2xl">
        <div className="brand border w-1/2 flex  items-center font-bold text-xl flex-col p-3 drop-shadow-2xl">
          {" "}
          <p>{product.brand}</p>{" "}
        </div>
        <div className="title  w-1/2 flex  items-center  text-xl flex-col p-3 ">
          {" "}
          <p>{product.title}</p>{" "}
        </div>
        <div className="description  w-1/2 flex  text-xl items-center  flex-col p-3 ">
          {" "}
          <p>{product.description}</p>
        </div>
        <div className="flex gap-2 items-end p-3  w-1/2 items-center  justify-evenly ">
        ...
        <div className="reting flex    w-1/2   items-center   ">
        ...
        <div className="border w-1/2 flex  items-center  flex-col p-3 ">
          <button
            onClick={() => {
        ...
        <div className="border w-1/2 flex  items-center  flex-col p-3 drop-shadow-2xl">
          <button
            onClick={() => {
        ...
        <div className="buy border w-1/2 flex  items-center flex-col p-3 drop-shadow-2xl  "> <button className="font-bold text-xl hover:opacity-50  px-3 py-1 w-1/2 border-slate-800 rounded-md bg-amber-600 border " onClick={payment}>Buy</button></div>
        </div>
      </div>
    </div>
  );
