...
const navigate=useNavigate();
    const sign =async ()=>{
        ...
        const data=await loginfxn({password,number},settest)
    ...
    return( <div className=" flex  justify-center items-center ">
        ...
        <div className="  "> <button className="my-2 h-8 w-56 ml-16 rounded-lg border text-center drop-shadow-2xl bg-cyan-300 hover:opacity-50" onClick={()=>{
